...
import { openToGmail } from "../_lib/constants"
    ...
    <div className="w-full xl:h-[500px] h-fit bg-[#1E1E1E] text-white" id="careers">
        <div className="xl:divide-x divide-y xl:divide-y-0 divide-gray-500 flex xl:flex-row flex-col h-full w-full xl:items-center xl:justify-between" ref={mainRef} >
            <div className="flex flex-col gap-y-8 xl:w-1/2 w-full xl:px-16 px-10 pt-5 pb-10" ref={carrersRef}>
                ...
                <button
                onClick={openToGmail}
                className="border w-2/3 xl:w-1/2 xl:py-5 py-3 text-xs xl:text-base uppercase font-medium hover:bg-white hover:text-black transition-all duration-500">
                    Join us
                </button>
            </div>
